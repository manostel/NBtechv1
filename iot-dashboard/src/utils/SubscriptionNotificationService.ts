<<<<<<< HEAD:iot-dashboard/src/utils/SubscriptionNotificationService.js
=======
...
class SubscriptionNotificationService extends EventEmitter {
  ...
  formatNotificationMessageFromNotification(notification: any) {
  ...
  getNotificationSeverityFromParam(parameterName: string): 'success' | 'error' | 'info' | 'warning' {
  ...
  async checkSingleSubscription(subscription: any) {
    try {
  ...
  evaluateCondition(conditionType: string, currentValue: any, thresholdValue: any) {
  ...
  formatNotificationMessage(subscription: any, currentValue: any) {
  ...
  getNotificationSeverity(subscription: any): 'success' | 'error' | 'info' | 'warning' {
  ...
  storeNotification(notification: SubscriptionNotification) {
    try {
  ...
  getStoredNotifications(): SubscriptionNotification[] {
    try {
  ...
  async sendEmailNotification(notification: SubscriptionNotification) {
    try {
  ...
  async triggerManualCheck(deviceId: string, parameterName: string, currentValue: any) {
    try {
      const response = await fetch('https://9mho2wb0jc.execute-api.eu-central-1.amazonaws.com/default/manage-subscriptions', {
        method: 'POST',
        headers: {
...
>>>>>>> dev-AWS-Connect-optimize:iot-dashboard/src/utils/SubscriptionNotificationService.ts
