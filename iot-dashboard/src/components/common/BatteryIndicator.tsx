<<<<<<< HEAD:iot-dashboard/src/components/BatteryIndicator.js
=======
...
const BatteryIndicator: React.FC<BatteryIndicatorProps> = ({ value, charging }) => {
...
>>>>>>> dev-AWS-Connect-optimize:iot-dashboard/src/components/common/BatteryIndicator.tsx
