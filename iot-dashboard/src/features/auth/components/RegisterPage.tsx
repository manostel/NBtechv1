<<<<<<< HEAD:iot-dashboard/src/components/RegisterPage.js
=======
...
const RegisterPage: React.FC<RegisterPageProps> = ({ onRegister }) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // Store the user data including client_id - map to User interface
      onRegister({ 
        email: data.email,
      ...
      >
        ...
        <Box component="form" onSubmit={handleSubmit} sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
          ...
          <TextField
            ...
            error={Boolean(error) && error !== null && error.includes('match')}
            helperText={Boolean(error) && error !== null && error.includes('match') ? error : ''}
            sx={{
              '& .MuiOutlinedInput-root': {
                borderRadius: 2,
                transition: 'all 0.3s ease',
...
>>>>>>> dev-AWS-Connect-optimize:iot-dashboard/src/features/auth/components/RegisterPage.tsx
