<<<<<<< HEAD:iot-dashboard/src/components/dashboard2/DashboardSubscriptionsTab.js
=======
...
const DashboardSubscriptionsTab: React.FC<DashboardSubscriptionsTabProps> = ({ 
  device, 
  user, 
  onNotification 
}) => {
        ...
        <CardContent sx={{ p: 3, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            {subscription.tolerance_percent && (
              ...
              {subscription.commands && subscription.commands.some((cmd: any) => cmd.action !== 'none') && (
                subscription.commands
                  .filter((cmd: any) => cmd.action !== 'none')
...
>>>>>>> dev-AWS-Connect-optimize:iot-dashboard/src/features/dashboard/components/DashboardSubscriptionsTab.tsx
