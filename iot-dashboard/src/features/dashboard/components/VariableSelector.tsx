<<<<<<< HEAD:iot-dashboard/src/components/dashboard2/VariableSelector.js
=======
...
interface VariableSelectorProps {
  ...
  onVariableChange: (event: { target: { value: string[] | string } }) => void;
  label?: string;
...
const VariableSelector: React.FC<VariableSelectorProps> = ({ 
  ...
  const [tempSelected, setTempSelected] = useState<string[] | string>(selectedVariables);
        ...
        >
          {variables.map((variable) => (
            ...
            >
              {!singleSelect && (
                <Checkbox 
                  checked={Array.isArray(tempSelected) ? tempSelected.indexOf(variable) > -1 : tempSelected === variable} 
                  size="small"
                  sx={{
                    color: 'text.secondary',
                    padding: '4px',
...
>>>>>>> dev-AWS-Connect-optimize:iot-dashboard/src/features/dashboard/components/VariableSelector.tsx
