...
// import MetricCard from "./MetricCard"; // Not used in original code
  ...
  return (
    <>
      <DeviceInfoCard
        ...
        deviceType={device.device_type || (device.latest_data as any)?.device || 'Unknown'}
                  ...
                  <Box
                    sx={{
                      ...
                      bgcolor: value !== undefined && !isNaN(value) ? (
                        // @ts-ignore - alertThresholds optional in type
