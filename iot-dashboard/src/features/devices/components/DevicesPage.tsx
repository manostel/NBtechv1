<<<<<<< HEAD:iot-dashboard/src/components/DevicesPage.js
=======
...
import SettingsDrawer from "../../dashboard/components/SettingsDrawer";
  ...
  return (
    <Box sx={{ height: 'calc(100vh - 200px)', width: '100%', position: 'relative' }}>
      ...
      {selectedDeviceForBluetooth && (
        <BluetoothControl
          device={{
            client_id: selectedDeviceForBluetooth.client_id,
            name: selectedDeviceForBluetooth.name || selectedDeviceForBluetooth.device_name || 'Unknown Device'
          }}
...
>>>>>>> dev-AWS-Connect-optimize:iot-dashboard/src/features/devices/components/DevicesPage.tsx
