...
interface SettingsDrawerProps {
  ...
  onAlertThresholdChange?: (metric: string, type: string) => (event: React.ChangeEvent<HTMLInputElement>) => void;
...
const SettingsDrawer: React.FC<SettingsDrawerProps> = ({ 
  ...
  const handlePushToggle = (event: React.ChangeEvent<HTMLInputElement>): void => {
  ...
  const handleDefaultTimeRange = (e: React.ChangeEvent<{ value: unknown }>): void => {
    setDefaultTimeRange(e.target.value);
    localStorage.setItem('defaultTimeRange', e.target.value);
  };

  const handleRefreshLatestSecs = (e: React.ChangeEvent<HTMLInputElement>): void => {
  ...
  const handleReduceMotion = (e: React.ChangeEvent<HTMLInputElement>): void => {
  ...
  const handleCompactUI = (e: React.ChangeEvent<HTMLInputElement>): void => {
